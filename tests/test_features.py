"""
Tests feature pipeline functions: Unit test and integration tests
"""
...
# ---------- load.py - Unit tests ----------
def test_load_and_split(tmp_path: Path | str):
  ...
  assert valid["date"].min() >= pd.to_datetime("2020-01-01")
...
# ---------- Integration Tests ----------
def test_full_pipeline_integration(tmp_path: str):
  raw = pd.DataFrame({
    "date": pd.date_range("2018-01-01", periods=6, freq="365D"),
    "price": [100, 200, 300, 400, 500, 600],
