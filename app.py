...
HOLDOUT_ENGINEERED_PATH = load_from_s3(
  ...
  "data/clean/feature_engineered_test.csv"
)
HOLDOUT_META_PATH = load_from_s3(
  "processed/cleaning_test.csv",
  "data/clean/cleaning_test.csv"
)
...
# ---------- UI ----------
st.title("🏠 Housing Price Prediction — Test Data Explorer")
